namespace Eshopworld.Tests.Core
{
    ...
    [TraitDiscoverer("Eshopworld.Tests.Core.EswCategoryDiscoverer", "Eshopworld.Tests.Core")]
    [AttributeUsage(AttributeTargets.Method, AllowMultiple = true, Inherited = true)]
    public class FooTestAttribute : Attribute, ITraitAttribute
    {
    }
    ...
    public class EswCategoryDiscoverer : ITraitDiscoverer
    {
        ...
        {
            yield return new KeyValuePair<string, string>("Category", "crapzor");
